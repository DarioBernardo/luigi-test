...
# Read the data
df_london = pd.read_csv("london_temperature.csv", sep=',', parse_dates=[0], encoding='utf-8')
...
df_rome = pd.read_csv("rome_temperature.csv", sep=',', parse_dates=[0], index_col=0, encoding='utf-8')
df_rome.index.name=None
df_rome.index = df_rome.index.date
df_rome.columns = ['max_rome','min_rome']


df_terme = pd.read_csv("terme_temperature.csv", sep=',', parse_dates=[0], index_col=0, encoding='utf-8')
df_terme.index.name=None
df_terme.columns = ['max_terme','min_terme']

df_stockholm = pd.read_csv("stockholm_temperature.csv", sep=',', parse_dates=[0], index_col=0, encoding='utf-8')
